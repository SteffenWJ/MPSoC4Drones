...
# module references:
# bram_addr_mapper, bram_addr_mapper, counter
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net counter_0_counterValue [get_bd_pins KalmanFilterKernel_0/clockLow] [get_bd_pins counter_0/counterValue]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins KalmanFilterKernel_0/ap_rst_n] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins bram_addr_mapper_0/n_rst_in] [get_bd_pins bram_addr_mapper_1/n_rst_in] [get_bd_pins counter_0/rst] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
