...
entity KalmanFilterKernel_AXI_CPU_s_axi is
generic (
...
end entity KalmanFilterKernel_AXI_CPU_s_axi;
...
architecture behave of KalmanFilterKernel_AXI_CPU_s_axi is
    ...
    constant ADDR_Q_CTRL   : INTEGER := 16#14#;
    constant ADDR_R_DATA_0 : INTEGER := 16#18#;
    constant ADDR_R_CTRL   : INTEGER := 16#1c#;
